...
export default function ThreatsPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Active Threats</h2>
        <p className="text-zinc-400">
          Aggregated view of all malicious flows and high-threat score findings.
        </p>
      </div>
